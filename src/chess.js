...
//   - Board rendering: renders a FEN position as an HTML tap-to-move
//     <table> (see src/index.js for how the move/select links get built)
//   - Puzzle logic: replays a Lichess puzzle PGN into FEN positions and
//     applies solution moves
//   - Local AI opponent: picks moves for the anonymous, no-login "vs AI"
//     mode (see README for how this differs from the real Lichess AI)
//
// chess.js runs here on the Worker only (server-side) - the phone never
// runs any JS, it just gets a fresh rendered board + form on every request.
// ---------------------------------------------------------------------------
...
// all run through chess.js above - no Lichess API call, no OAuth token,
